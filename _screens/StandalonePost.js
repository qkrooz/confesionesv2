        ...
        <View style={styles.postContainer}>
          ...
          <View style={styles.headerControls}>
            <View style={styles.postInfo}>
              ...
              <View style={styles.timeStampContainer}>
                <Text style={{fontSize: 5, marginRight: 5, color: 'black'}}>
                  {'\u2B24'}
                </Text>
                <Text style={{fontSize: 10, color: 'grey', fontSize: 13}}>
                  Hace 5 minutos
                </Text>
              </View>
            </View>
            {/* More */}
            <TouchableWithoutFeedback onPress={() => route.params.postModal()}>
              <Icon
          ...
          <View style={styles.textContainer}>
            <Text style={{textAlign: 'center', color: 'black', fontSize: 16}}>
              ...
              sit amet libero molestie, lobortis felis vel, congue metus.
              Integer vitae tempor risus. Nam sit amet augue ut gravida.{' '}
            </Text>
          </View>
          {/* Header Text ENDS */}
          {/* Image */}
